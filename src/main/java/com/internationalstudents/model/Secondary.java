...
public class Secondary {
    ...
    public void set(String date, String issued, String issued_date, String identity, String address, String tel_mob, String tel_home, String email, String job, String post) {
        this.date = date;
        this.issued = issued;
